...
public class AfficherReclamationPerUserController {
    ...
    public void initialize(){
        showAllReclamation(rss.afficherparUser(Session.getUserId()));
    ...
    public void switchToAllReclamation() throws IOException {
        ss.SwitchScene2(event,"AfficherReclamationUser",tfS);
    }

    public void switchToAjouterReclamation() throws IOException {
        ss.SwitchScene(event,"AjouterReclamation");
    }

    public void SwitchToGroupe(ActionEvent actionEvent) throws IOException {
